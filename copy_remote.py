...
if __name__ == '__main__':
    ...
    dir = os.path.join(chrootedProjectPath, "OffloadData")
    os.system("mkdir %s" % dir)
    os.system("chown scipionuser %s" % dir)
    #
    dir = os.path.join(chrootedProjectPath, "Project")
    os.system("mkdir %s" % dir)
    os.system("chown scipionuser %s" % dir)
    ...
    source = os.path.join(DATADIR, EPUDATADIR)
    ...
    #
    source = os.path.join(DATADIR, PROJECTDIR)
